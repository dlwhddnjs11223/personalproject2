package org.sparta.personalproject.todo.entity;
...
import org.sparta.personalproject.comment.Comment;
...
@NoArgsConstructor
public class Todo extends org.sparta.personalproject.todo.entity.Timestamped {
    @Id
